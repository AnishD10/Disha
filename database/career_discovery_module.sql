-- DISHA Career Discovery Backend Module
-- Run after the base users table exists. This script recreates the career discovery tables.
...
DROP TABLE IF EXISTS career_match_rules;
DROP TABLE IF EXISTS aptitude_profiles;
...
CREATE TABLE career_match_rules (
...
VALUES
(1, 'Software Engineer',
 'Designs, builds, tests, and maintains web, mobile, and enterprise software systems.',
 'Develop applications, review code, write tests, debug production issues, collaborate with product teams, and improve system performance.',
 'Information Technology',
 'Strong demand in Nepal for fintech, edtech, outsourcing, SaaS, and remote international engineering roles.',
 420000, 900000, 1800000, 'HIGH', 'MEDIUM', 'HIGH', 18.50,
 'A high-growth technology career for students with strong technical and analytical aptitude.',
 'Oracle Java Certification, AWS Cloud Practitioner, Scrum Fundamentals'),
(2, 'UI/UX Designer',
 'Researches user needs and creates accessible digital experiences for websites and apps.',
 'Conduct user interviews, design wireframes, build prototypes, run usability tests, and collaborate with developers.',
 'Digital Product Design',
 'Growing opportunity as Nepali startups and service companies improve digital products for local and global users.',
 300000, 720000, 1400000, 'HIGH', 'LOW', 'HIGH', 15.00,
 'Ideal for creative students who communicate clearly and enjoy solving usability problems.',
 'Google UX Design Certificate, Human-Computer Interaction, Figma Professional Training'),
(3, 'Data Analyst',
 'Turns raw data into reports, dashboards, and insights for business and public-sector decisions.',
 'Clean datasets, write SQL queries, build dashboards, analyze trends, and present insights to stakeholders.',
 'Data and Business Intelligence',
 'High growth as banks, NGOs, ecommerce companies, and government projects adopt data-driven planning.',
 360000, 780000, 1500000, 'HIGH', 'MEDIUM', 'MEDIUM', 17.00,
 'Best suited to analytical students who enjoy research, statistics, and practical business problem solving.',
 'Google Data Analytics, Microsoft Power BI Data Analyst, Tableau Desktop Specialist'),
(4, 'Public Health Researcher',
 'Studies health trends, evaluates programs, and supports evidence-based health policy in Nepal.',
 'Design surveys, collect and analyze health data, write research reports, and coordinate with communities and institutions.',
 'Public Health and Development',
 'Stable demand through NGOs, INGOs, hospitals, universities, and public health agencies.',
 320000, 760000, 1300000, 'MEDIUM', 'LOW', 'MEDIUM', 9.50,
 'A research-oriented career for students interested in community impact and evidence-based policy.',
 'Research Ethics, SPSS/STATA Training, Monitoring and Evaluation Certificate'),
(5, 'Digital Marketing Strategist',
 'Plans campaigns across social media, search, content, and analytics to grow brands and products.',
 'Create campaign strategy, manage ads, write content briefs, analyze conversion data, and coordinate creative teams.',
 'Marketing and Media',
 'Demand is increasing as Nepali businesses shift to ecommerce, tourism marketing, and online services.',
 300000, 650000, 1200000, 'HIGH', 'MEDIUM', 'HIGH', 14.00,
 'Good fit for students with creativity, communication, and entrepreneurial thinking.',
 'Google Ads Certification, Meta Blueprint, HubSpot Content Marketing'),
(6, 'Civil Engineer',
 'Plans, designs, and supervises infrastructure projects such as roads, buildings, bridges, and water systems.',
 'Prepare designs, inspect construction work, manage site teams, estimate costs, and ensure safety compliance.',
 'Engineering and Infrastructure',
 'Long-term demand continues through urban development, hydropower, roads, reconstruction, and municipal planning.',
 360000, 840000, 1600000, 'MEDIUM', 'LOW', 'LOW', 8.00,
 'Suited to analytical and leadership-focused students who want tangible infrastructure impact.',
 'Nepal Engineering Council License, AutoCAD Civil 3D, Project Management Fundamentals');
...
INSERT INTO career_skills (career_id, skill_name, skill_type, skill_level) VALUES
...
INSERT INTO career_roadmaps (career_id, stage_name, description, estimated_duration, stage_order) VALUES
...
INSERT INTO career_courses (career_id, course_name, platform, difficulty, duration, free_paid) VALUES
...
-- Optional sample student profile. Requires a user with user_id = 2 and role STUDENT.
