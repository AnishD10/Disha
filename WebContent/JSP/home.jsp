...
<nav class="landing-nav" id="mainNav">
    <div class="nav-container">
        <a href="#" class="nav-logo">
            <div class="nav-logo-icon">D</div> DISHA</a>
...
<section class="hero" id="home">
    <div class="hero-container">
        <div class="hero-content">
            ...
            <h1 class="hero-title"> Find the Right<span class="highlight">Career Path</span> with Real Nepal Market Data
            </h1>
            <p class="hero-desc"> Disha is Nepal's first AI-powered career intelligence platform that matches your aptitude, interests, and budget with real labor market opportunities - helping you make smarter career decisions.</p>
            <div class="hero-buttons">
                <a href="<%= request.getContextPath() %>/JSP/auth/register.jsp" class="btn-hero-primary">Get Started Free -></a>
                <a href="<%= request.getContextPath() %>/JSP/auth/login.jsp" class="btn-hero-secondary">Take Career Test</a>
            </div>
    ...
    <div class="section-container">
        <div class="about-grid">
            ...
            <div class="about-text">
                ...
                <p> Every year, thousands of Nepali students make life-changing career decisions based on peer pressure, family expectations, or outdated information. Many end up in careers that don't match their skills or market realities.</p>
                <p>
    ...
    <div class="section-container">
        ...
        <div class="testimonials-grid">
            <div class="testimonial-card">
                ...
                <p class="testimonial-text"> "I was confused between engineering and medicine. Disha's aptitude test and salary insights showed me that my analytical skills perfectly match software engineering. Now I'm preparing for BScCSIT at TU with a clear goal!"</p>
            ...
            <div class="testimonial-card">
                <div class="testimonial-stars">*****</div>
                <p class="testimonial-text"> "As a parent, I was worried about my daughter's career choice. Disha gave me detailed reports showing her strengths, career matches, and even the budget required. It gave our family the confidence to support her path."</p>
                <div class="testimonial-author">
            ...
            <div class="testimonial-card">
                <div class="testimonial-stars">*****</div>
                <p class="testimonial-text"> "Managing 200+ students used to be overwhelming. Disha's counselor dashboard gives me analytics, risk alerts, and individual progress tracking. It's completely transformed how I guide students in their career decisions."</p>
                <div class="testimonial-author">
...
<section class="section" id="faq">
    <div class="section-container">
        ...
        <div class="faq-container">
            <div class="faq-item">
                <button class="faq-question">Who can use Disha? <span class="icon">v</span></button>
                <div class="faq-answer">
                    <div class="faq-answer-inner"> Disha is designed for high school (+2) students preparing for further education or entering the job market, parents wanting to guide their children, career switchers looking for data-driven insights, and career counselors needing scalable tools for their clients.</div>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">Is the assessment free? <span class="icon">v</span></button>
                <div class="faq-answer">
                    <div class="faq-answer-inner"> Yes! Your initial aptitude assessment and basic career matching are completely free. We believe every student should have access to basic career guidance. We do offer premium features for advanced counselor consulting.</div>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">How are careers recommended? <span class="icon">v</span></button>
                <div class="faq-answer">
                    <div class="faq-answer-inner"> Our recommendation engine uses a proprietary algorithm that cross-references your cognitive aptitude scores, personal interests, educational budget constraints, and current labor market demand data in Nepal to suggest the most optimal career paths.</div>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">How long does the assessment take? <span class="icon">v</span></button>
                <div class="faq-answer">
                    <div class="faq-answer-inner"> The core aptitude test takes approximately 20-30 minutes to complete. It evaluates various cognitive domains including numerical, verbal, abstract reasoning, and spatial awareness.</div>
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">Can parents monitor progress? <span class="icon">v</span></button>
                <div class="faq-answer">
                    <div class="faq-answer-inner"> Absolutely. Parents can create "Parent" accounts and link them to their child's account to receive automated reports, view assessment results, and explore budget/college planning tools together.</div>
                </div>
            </div>
        </div>
    </div>
...
<section class="cta-section">
    <div class="cta-content">
        ...
        <div class="cta-buttons">
            <a href="<%= request.getContextPath() %>/JSP/auth/register.jsp" class="btn-cta-white">Create Free Account</a>
            <a href="<%= request.getContextPath() %>/JSP/auth/login.jsp" class="btn-cta-outline"> Already have an account? Log In</a>
        </div>
    </div>
</section>
...
<!--
     MINIMAL JAVASCRIPT
      -->
<script> // Sticky navbar shadow on scroll
