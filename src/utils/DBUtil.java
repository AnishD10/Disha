...
public class DBUtil {
    ...
    // Defaults match the shared local DISHA development database.
    ...
    private static final String DB_PASSWORD = System.getenv("DB_PASSWORD") != null ? System.getenv("DB_PASSWORD") : "its2026";
