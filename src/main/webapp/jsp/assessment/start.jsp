...
<head>
    ...
    <meta name="description" content="Begin your career assessment with DISHA. Discover your strengths and ideal career paths in Nepal.">
    ...
    <style>
        ...
        .chip-icon.blue  { background: var(--primary-100); }
        .chip-icon.green { background: var(--success-bg); }
        ...
        .stat-icon-wrap.blue  { background: var(--primary-100); }
        .stat-icon-wrap.cyan  { background: #ECFEFF; }
        ...
        /* ─── SECTION CARDS ────────────────────── */
        .sections-block { padding: 0 0 40px; }
        ...
        .section-card.blue::before  { background: var(--primary-gradient); }
        .section-card.teal::before  { background: linear-gradient(135deg, #0EA5E9, #06B6D4); }
        .section-card.green::before { background: linear-gradient(135deg, #22C55E, #16A34A); }
        ...
        .section-card.blue  .section-card-icon { background: var(--primary-100); }
        .section-card.teal  .section-card-icon { background: #ECFEFF; }
        .section-card.green .section-card-icon { background: var(--success-bg); }
        ...
        .section-card.blue  .section-card-letter { background: var(--primary-100); color: var(--primary-dark); }
        .section-card.teal  .section-card-letter { background: #ECFEFF; color: var(--info); }
        .section-card.green .section-card-letter { background: var(--success-bg); color: #15803D; }
        ...
        @media (max-width: 980px) {
            ...
            .stats-row, .sections-grid { grid-template-columns: 1fr; }
            .cta-block { grid-template-columns: 1fr; }
            .btn-cta { width: 100%; justify-content: center; }
            .trust-row { flex-direction: column; gap: 14px; }
            .top-nav { padding: 0 var(--space-5); }
...
<div class="main-wrapper">
    ...
    <header class="topnav">
        ...
        <a href="${pageContext.request.contextPath}/assessment/history" class="btn btn-outline" style="padding: 8px 16px;">
            📊 My Results
        </a>
    ...
    <div class="stats-row animate-fade-in delay-1">
        ...
        <div class="stat-card">
            ...
            <div>
                <div class="stat-label" style="margin-bottom: 4px; font-size: 16px; font-weight: 700; color: var(--text-primary);">Unlimited</div>
    ...
    <div class="sections-block animate-fade-in delay-2">
        ...
        <div class="sections-grid">
            <div class="section-card blue">
                ...
                <div class="section-card-desc">Measures your cognitive abilities, logical reasoning, and problem-solving skills.</div>
            </div>
            <div class="section-card teal">
                <div class="section-card-icon">🌟</div>
                <div class="section-card-letter">B</div>
                <div class="section-card-name">Personality</div>
                <div class="section-card-desc">Understands your behavioral patterns, preferences, and personality traits.</div>
            </div>
            <div class="section-card green">
                <div class="section-card-icon">🎯</div>
                <div class="section-card-letter">C</div>
                <div class="section-card-name">Interest</div>
                <div class="section-card-desc">Identifies your areas of passion and career inclinations for the future.</div>
            </div>
        </div>
    </div>
    ...
    <div class="cta-block animate-fade-in delay-2">
        <div class="notice-card">
            ...
            <div>
                ...
                <div class="notice-desc">Sections B and C have no right or wrong answers. Your results are saved privately to your profile only.</div>
            </div>
        </div>
