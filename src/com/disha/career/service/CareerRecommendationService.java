package com.disha.career.service;

import com.disha.career.dao.CareerDiscoveryDAO;
...
public class CareerRecommendationService {
    ...
    private final CareerDiscoveryDAO careerDAO;

    public CareerRecommendationService() {
        this(new CareerDiscoveryDAO());
    }

    public CareerRecommendationService(CareerDiscoveryDAO careerDAO) {
